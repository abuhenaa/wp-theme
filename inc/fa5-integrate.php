<?php
//
// Add font-awesome css file in backend
//
function saiful_font_awesome_css() {
  wp_enqueue_style( 'fontawesome5', 'https://use.fontawesome.com/releases/v5.7.2/css/all.css', array(), '5.7.2', 'all' );
}
add_action( 'admin_enqueue_scripts', 'saiful_font_awesome_css' );

//
// Add font-awesome 5.x icons array
//
function saiful_font_awesome_icons( $icons ) {
...
add_filter( 'csf_field_icon_add_icons', 'saiful_font_awesome_icons' );